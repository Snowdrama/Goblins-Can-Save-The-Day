...
public partial class CommandConsole : Node
{
 ...
 //   //this would be for broad globalCommands like "KillAll" or "HealAll 100"
 //   public static void AddAction(string actionName, Action action)
 //   {
 //       globalCommands[actionName] += action;
 //   }

 //   public static void RemoveAction(string actionName, Action action)
 //   {
 //       globalCommands[actionName] -= action;
 //   }
